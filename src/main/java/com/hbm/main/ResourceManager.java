...
public class ResourceManager {
	...
	// NTM Hard Stuff
	public static final IModelCustom bftrigonome = new HFRWavefrontObject(new ResourceLocation(RefStrings.MODID, "models/machines/bftrigonome.obj")).asVBO();
	public static final ResourceLocation bftrig_tex = new ResourceLocation(RefStrings.MODID, "textures/models/machines/bftrigonome.png");
