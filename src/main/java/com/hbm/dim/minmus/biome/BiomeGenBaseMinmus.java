...
public abstract class BiomeGenBaseMinmus extends BiomeGenBaseCelestial {
	...
	public static final BiomeGenBase minmusPlains = new BiomeGenMinmusHills(SpaceConfig.minmusBiome);
	public static final BiomeGenBase minmusCanyon = new BiomeGenMinmusBasin(SpaceConfig.minmusBasinBiome);
