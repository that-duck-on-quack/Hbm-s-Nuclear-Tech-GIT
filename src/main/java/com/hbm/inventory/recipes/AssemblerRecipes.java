...
public class AssemblerRecipes extends SerializableRecipe {
	...
	public void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModItems.warhead_cluster_small, 1), new AStack[] {
			new ComparableStack(ModItems.warhead_generic_small, 1),
			new ComparableStack(ModItems.pellet_cluster, 4),
		},100);
		...
		makeRecipe(new ComparableStack(ModItems.warhead_buster_small, 1), new AStack[] {
			new ComparableStack(ModItems.warhead_generic_small, 1),
			new ComparableStack(ModBlocks.det_charge, 4),
			new ComparableStack(ModBlocks.det_cord, 2),
			new ComparableStack(ModItems.circuit, 2, EnumCircuitType.BASIC),
			new OreDictStack(U238.ingot(), 2)
		},100);
		makeRecipe(new ComparableStack(ModItems.warhead_buster_medium, 1), new AStack[] {
			new ComparableStack(ModItems.warhead_generic_medium, 1),
			new ComparableStack(ModBlocks.det_cord, 4),
		...
		makeRecipe(new ComparableStack(ModItems.pellet_cluster, 1), new AStack[] {
			new OreDictStack(STEEL.plate(), 4),
			new OreDictStack(ANY_PLASTICEXPLOSIVE.ingot(), 8),
			new ComparableStack(ModBlocks.det_cord, 8),
			new ComparableStack(ModItems.safety_fuse, 2)
		}, 50);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_chemplant, 1), new AStack[] {new OreDictStack(STEEL.ingot(), 12), new OreDictStack(CU.plate528(), 6), new ComparableStack(ModItems.tank_steel, 4), new ComparableStack(ModItems.coil_tungsten, 3), new ComparableStack(ModItems.crude_circuit), new ComparableStack(ModItems.plate_polymer, 8), },200);
		makeRecipe(new ComparableStack(ModBlocks.machine_chemical_plant, 1), new AStack[] {new OreDictStack(STEEL.ingot(), 8), new OreDictStack(CU.pipe(), 2), new ComparableStack(ModItems.plate_polymer, 16), new ComparableStack(ModItems.motor, 2), new ComparableStack(ModItems.coil_tungsten, 2), new ComparableStack(ModItems.crude_circuit) }, 200);
		...
		makeRecipe(new ComparableStack(ModBlocks.fusion_center, 1), new AStack[] {new ComparableStack(ModItems.ingot_pc,8), new OreDictStack(STEEL.plate528(), 6), new OreDictStack(ALLOY.wireFine(), 24), },200);
		...
		makeRecipe(new ComparableStack(ModBlocks.watz_element, 3), new AStack[] {new OreDictStack(STEEL.plateCast(), 2), new OreDictStack(ZR.ingot(), 2), new OreDictStack(BIGMT.ingot(), 2), new ComparableStack(ModItems.ingot_pc,8)},200);
		...
		makeRecipe(new ComparableStack(ModItems.grenade_nuclear, 1), new AStack[] {new OreDictStack(IRON.plate(), 1), new OreDictStack(STEEL.plate(), 1), new OreDictStack(PU239.nugget(), 9), new OreDictStack(MINGRADE.wireFine(), 2), },200);
		...
		makeRecipe(new ComparableStack(ModItems.mp_thruster_20_hydrogen, 1), new AStack[] {new ComparableStack(ModItems.seg_20, 1), new OreDictStack(STEEL.pipe(), 1), new OreDictStack(W.ingot(), 8), new OreDictStack(STEEL.plate(), 6), new ComparableStack(ModItems.plate_desh, 2), },500);
		makeRecipe(new ComparableStack(ModItems.mp_thruster_20_hydrogen_dual, 1), new AStack[] {new ComparableStack(ModItems.seg_20, 1), new OreDictStack(STEEL.pipe(), 1), new OreDictStack(W.ingot(), 12), new OreDictStack(STEEL.plate(), 8), new ComparableStack(ModItems.plate_desh, 4), },500);
		makeRecipe(new ComparableStack(ModItems.mp_thruster_20_hydrogen_triple, 1), new AStack[] {new ComparableStack(ModItems.seg_20, 1), new OreDictStack(STEEL.pipe(), 1), new OreDictStack(W.ingot(), 16), new OreDictStack(STEEL.plate(), 12), new ComparableStack(ModItems.plate_desh, 6), },500);
		...
		makeRecipe(new ComparableStack(ModItems.mp_warhead_10_nuclear, 1), new AStack[] {new ComparableStack(ModItems.seg_10, 1), new OreDictStack(STEEL.plate(), 6), new OreDictStack(PU239.ingot(), 2), new OreDictStack(OreDictManager.getReflector(), 16), new ComparableStack(ModItems.ball_tatb, 4), new ComparableStack(ModItems.circuit, 3, EnumCircuitType.CONTROLLER_ADVANCED), },200);
		makeRecipe(new ComparableStack(ModItems.mp_warhead_10_nuclear_large, 1), new AStack[] {new ComparableStack(ModItems.seg_10, 1), new OreDictStack(STEEL.plate(), 8), new OreDictStack(AL.plate(), 4), new OreDictStack(PU239.ingot(), 6), new ComparableStack(ModItems.ball_tatb, 8), new ComparableStack(ModItems.circuit,5, EnumCircuitType.CONTROLLER_ADVANCED), },300);
		...
		makeRecipe(new ComparableStack(ModItems.mp_warhead_15_nuclear, 1), new AStack[] {new ComparableStack(ModItems.seg_15, 1), new OreDictStack(STEEL.plate(), 24), new OreDictStack(TI.plate(), 12), new OreDictStack(PU239.ingot(), 9), new ComparableStack(ModItems.ball_tatb, 16), new ComparableStack(ModItems.circuit, 7, EnumCircuitType.CONTROLLER_ADVANCED), },500);
		...
		makeRecipe(new ComparableStack(ModItems.fusion_shield_tungsten, 1), new AStack[] {new OreDictStack(W.block(), 32), new OreDictStack(LI.dust(), 32), new OreDictStack(OreDictManager.getReflector(), 96)}, 600);
		makeRecipe(new ComparableStack(ModItems.fusion_shield_desh, 1), new AStack[] {new OreDictStack(DESH.block(), 16), new OreDictStack(LI.dust(), 64),new OreDictStack(CO.block(), 16), new OreDictStack(BIGMT.plate(), 96)}, 600);
		makeRecipe(new ComparableStack(ModItems.fusion_shield_chlorophyte, 1), new AStack[] {new OreDictStack(W.block(), 16), new OreDictStack(LI.dust(), 128),new OreDictStack(DURA.block(), 16), new OreDictStack(OreDictManager.getReflector(), 48), new ComparableStack(ModItems.powder_chlorophyte, 48)}, 600);
		...
		makeRecipe(new ComparableStack(ModItems.sat_head_laser, 1), new AStack[] {
				...
				new ComparableStack(ModItems.ingot_pc,1),
		...
		makeRecipe(new ComparableStack(ModItems.upgrade_overdrive_1, 1), new AStack[] {
				...
				new ComparableStack(ModItems.ingot_pc,16),
				new ComparableStack(ModItems.circuit, 16, EnumCircuitType.ADVANCED),
			}, 200);
		...
		makeRecipe(new ComparableStack(ModBlocks.turret_maxwell, 1), new AStack[] { //fuck you cunts
				new ComparableStack(ModBlocks.machine_lithium_battery, 1),
				new OreDictStack(STEEL.ingot(), 24),
				new ComparableStack(ModItems.motor_bismuth, 2),
				new ComparableStack(ModItems.circuit, 3, EnumCircuitType.CONTROLLER_ADVANCED),
				...
				new OreDictStack(ANY_RESISTANTALLOY.plateCast(), 8),
				new ComparableStack(ModItems.crt_display, 1)
			}, 200);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_pyrooven, 1), new AStack[] {
				...
				new OreDictStack(ANY_PLASTIC.ingot(), 32),
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_electrolyser, 1), new AStack[] {
				...
				new OreDictStack(RUBBER.ingot(), 8),
				new ComparableStack(ModItems.arc_electrode, 1),
				new ComparableStack(ModItems.ingot_firebrick, 16),
				...
				new ComparableStack(ModItems.arc_electrode, 4, 2)
			}, 200);
		...
		makeRecipe(new ComparableStack(ModBlocks.pa_rfc), new AStack[] {
			...
			new ComparableStack(ModItems.ingot_pc,32),
				new ComparableStack(ModItems.magnetron, 16),
			}, 400);
		...
		makeRecipe(new ComparableStack(ModBlocks.pa_dipole), new AStack[] {
				...
				new OreDictStack(STEEL.plateCast(), 16),
			new ComparableStack(ModItems.ingot_pc,64),
				new ComparableStack(ModItems.circuit, 4, EnumCircuitType.BISMOID),
			}, 400);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_exposure_chamber, 1), new AStack[] {
				...
				new OreDictStack(ANY_RESISTANTALLOY.ingot(), 4),
			 		new OreDictStack(ANY_HARDPLASTIC.ingot(), 40),
		...
		makeRecipe(new ComparableStack(ModItems.rp_pod_20, 1), new AStack[] {
				...
				new ComparableStack(ModItems.tank_steel, 2),
				new OreDictStack(DURA.plate(), 16),
				new OreDictStack(FIBER.ingot(), 4),
				new OreDictStack(ANY_PLASTIC.ingot(), 4),
				new ComparableStack(ModItems.circuit, 2, EnumCircuitType.AVIONICS),
		...
		makeRecipe(new ComparableStack(ModItems.battery_sc_gold, 1), new AStack[]{
			new OreDictStack(ANY_PLASTIC.ingot(), 2),
			new ComparableStack(ModItems.battery_sc_polonium, 1),
			new OreDictStack(TA.nugget(), 4),
			new ComparableStack(ModItems.billet_au198, 2),
			new ComparableStack(ModItems.rtg_unit, 1)
		}, 250);
		makeRecipe(new ComparableStack(ModItems.battery_sc_lead, 1), new AStack[]{
			new OreDictStack(ANY_PLASTIC.ingot(), 8),
			new ComparableStack(ModItems.battery_sc_gold, 1),
			new OreDictStack(TA.nugget(), 4),
			new ComparableStack(ModItems.billet_pb209, 2),
			new ComparableStack(ModItems.rtg_unit, 1)
		}, 250);
		makeRecipe(new ComparableStack(ModItems.battery_sc_americium, 1), new AStack[]{
			new OreDictStack(ANY_PLASTIC.ingot(), 16),
			new ComparableStack(ModItems.battery_sc_lead, 1),
			new OreDictStack(TA.nugget(), 8),
			new ComparableStack(ModItems.billet_am241, 4),
