...
public class TileEntityTowerLarge extends TileEntityCondenser {
	...
	public static int evTankSizeTL = 5_000;
	...
	public void readIfPresent(JsonObject obj) {
		...
		evTankSizeTL = IConfigurableMachine.grab(obj, "I:evTankSize", evTankSizeTL);
	}
	...
	public void writeConfig(JsonWriter writer) throws IOException {
		...
		writer.name("I:evTankSize").value(evTankSizeTL);
	}
	...
	public void updateEntity() {
		...
		if(worldObj.isRemote) {
			...
			if(GeneralConfig.enableSteamParticles && (this.waterTimer > 0 && this.worldObj.getTotalWorldTime() % 4 == 0 && this.tanks[2].getFill() >= 5_000)) {
