...
// This is an example tileentity that transforms Water into BF Rocket Fuel.
public class TileEntityBFTrigonome extends TileEntityLoadedBase implements IFluidStandardTransceiver, INBTPacketReceiver, IInfoProviderEC, IConfigurableMachine, IFluidCopiable {
	...
	public TileEntityBFTrigonome() {
		tanks = new FluidTank[2];
		tanks[0] = new FluidTank(Fluids.WATER, inputTankSize);
		tanks[1] = new FluidTank(Fluids.BALEFIRE, outputTankSize);
	}
