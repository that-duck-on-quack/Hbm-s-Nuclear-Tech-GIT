 ...
 */
public class MachineDiFurnaceElectric extends BlockContainer {
	...
	public MachineDiFurnaceElectric(boolean blockState) {
		super(Material.iron);
		isActive = blockState;
	}
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.iconTop = iconRegister.registerIcon(RefStrings.MODID + (this.isActive ? ":difurnace_electric_top_on" : ":difurnace_electric_top_off"));
		this.iconFront = iconRegister.registerIcon(RefStrings.MODID + (this.isActive ? ":difurnace_electric_front_on" : ":difurnace_electric_front_off"));
	...
	public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
		return Item.getItemFromBlock(ModBlocks.machine_difurnace_electric_off);
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack itemStack) {
		...
		if(itemStack.hasDisplayName()) {
			((TileEntityDiFurnaceElectric) world.getTileEntity(x, y, z)).setCustomName(itemStack.getDisplayName());
		}
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		...
		if(world.isRemote) {
			...
			TileEntityDiFurnaceElectric entity = (TileEntityDiFurnaceElectric) world.getTileEntity(x, y, z);
			if(entity != null) {
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new TileEntityDiFurnaceElectric();
	}
	...
	public static void updateBlockState(boolean isProcessing, World world, int x, int y, int z) {
		...
		if(isProcessing) {
			world.setBlock(x, y, z, ModBlocks.machine_difurnace_electric_on);
		} else {
			world.setBlock(x, y, z, ModBlocks.machine_difurnace_electric_off);
		}
	...
	public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_,
			int p_149749_6_) {
		if(!keepInventory) {
			TileEntityDiFurnaceElectric tileentityfurnace = (TileEntityDiFurnaceElectric) p_149749_1_.getTileEntity(p_149749_2_,
